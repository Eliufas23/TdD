...
```{r}
ggplot(Mode)+
  geom_density(aes(cost.car), color="black", fill="gold3", alpha=0.6)+
  geom_density(aes(cost.carpool), color="black", fill="red3" , alpha=0.6)+
  geom_density(aes(cost.bus), color="black", fill="blue", alpha=0.6)+
  geom_density(aes(cost.rail), color="black", fill="cyan", alpha=0.6)+
  theme_bw()
```
...
```{r}
ggplot(Mode)+
  geom_density(aes(time.car), color="black", fill="gold3", alpha=0.4)+
  geom_density(aes(time.carpool), color="black", fill="red3" , alpha=0.4)+
  geom_density(aes(time.bus), color="black", fill="blue", alpha=0.4)+
  geom_density(aes(time.rail), color="black", fill="cyan", alpha=0.4)+
  theme_bw()
```
